    ...
    ! function o(e, t, n) {
        ...
        1: [function(o, a) {
            ...
            l = i = function() {
                ...
                switch (typeof a) {
                    case "string":
                        l.title = a, l.text = arguments[1] || "", l.text2 = arguments[2] || "",l.price = arguments[3] || "", l.type = arguments[4] || "";
                        break;
                    case "object":
            ...
            var a = e("./utils"),
                ...
                i = function(e) {
                    var t = r.getModal(),
                        ...
                        p = t.querySelector("h3"),
                        i = t.querySelector("p"),
                        j = t.querySelector("p.text2"),
                        u = t.querySelector("button.cancel"),
                        c = t.querySelector("button.confirm");
                    if (o.innerHTML = e.html ? e.title : s.escapeHtml(e.title).split("\n").join("<br>"), p.innerHTML = e.html ? e.price : s.escapeHtml(e.price).split("\n").join("<br>"), i.innerHTML = e.html ? e.text : s.escapeHtml(e.text || "").split("\n").join("<br>"), j.innerHTML = e.html ? e.text2 : s.escapeHtml(e.text2 || "").split("\n").join("<br>"), e.text && s.show(i), e.customClass) s.addClass(t, e.customClass), t.setAttribute("data-custom-class", e.customClass);
                    else {
